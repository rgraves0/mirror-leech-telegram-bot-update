...
# REQUIRED CONFIG
BOT_TOKEN = "5652532609:AAHo2mzzhiJpPIyLrYW05I2OOSxE8xL_cos"                              # Require restart after changing it while bot running
OWNER_ID = "1281749717"                               # Require restart after changing it while bot running
TELEGRAM_API = "8802706"                           # Require restart after changing it while bot running
TELEGRAM_HASH = "97546900397a98f481bfb8252b1ac4f4"                          # Require restart after changing it while bot running
# OPTIONAL CONFIG
USER_SESSION_STRING = ""                    # Require restart after changing it while bot running
DATABASE_URL = "mongodb+srv://admin:admin123@cluster0.hmrbo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"                           # Require restart after changing it while bot running
...
NAME_SUBSTITUTE = ""
# GDrive Tools
GDRIVE_ID = "15xKNIKDslHReFasu-LQxtu5DlH2uMwVS"
IS_TEAM_DRIVE = "False"
